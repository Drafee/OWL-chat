...
# ==============================================================================
                ...
                # ---- start your code ---- #
                out = msg["message"]
                self.indices[from_name].add_msg_and_index(str(text_proc(out, from_name)))
                ...
                for g in the_guys:
                    ...
                    # IMPLEMENTATION
                    # ---- start your code ---- #
                    self.indices[g].add_msg_and_index(str(text_proc(out, from_name)))
                    mysend(to_sock, json.dumps({"action": "exchange", "from": from_name, "message": out}))
...
# ==============================================================================
                ...
                # IMPLEMENTATION
                # ---- start your code ---- #
                p = self.sonnet.get_poem(int(msg["target"]))
                poem = "here\n"
                for line in p:
                    poem += str(line)+"\n"
...
# ==============================================================================
                ...
                from_name = self.logged_sock2name[from_sock]
                term = msg["target"]
                result = self.indices[from_name].search(term)
                if len(result) == 0:
                    search_rslt = ""
                else:
                    lst = []
